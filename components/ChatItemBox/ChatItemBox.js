  ...
  render() {
    return (
      <div className={styles.stKaiwaBox}>
        ...
        <div className={!this.state.flg?styles.stKaiwaArea:styles.stKaiwaArea2}>
          <div className={!this.state.flg?styles.stKaiwaHukidashi:styles.stKaiwaHukidashi2}>{this.state.comment}</div>
        </div>
        {this.state.flg &&
          <div className={styles.stKaiwaFace}>
            {this.state.img!=null &&
